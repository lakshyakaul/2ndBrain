...
// 				<article className="rounded-full p-[1px] text-sm dark:gradient-to-r dark:from-brand-primary-blue dark:to-brand-primary-purple">
// 					<div className="rounded-full px-3 py-1 dark:bg-black border-2 border-muted-foreground">
// 						{pill}
// 					</div>
// 				</article>
// 				{subheading ?
