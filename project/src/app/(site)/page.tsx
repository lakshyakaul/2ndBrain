	...
	return (
		<div className="min-h-screen bg-background text-foreground overflow-x-hidden pt-24 font-dm-sans">
			...
			<div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] pointer-events-none -z-10 overflow-hidden">
				<div className="absolute top-[-20%] left-[20%] w-[50%] h-[60%] rounded-full bg-brand-primary-blue/70 blur-[60px] dark:bg-brand-primary-blue/60" />
				<div className="absolute top-[-10%] right-[20%] w-[50%] h-[60%] rounded-full bg-brand-primary-purple/70 blur-[60px] dark:bg-brand-primary-purple/60" />
			...
			<section className="relative px-6 max-w-6xl mx-auto text-center flex flex-col items-center pb-16">
				...
				<div className="w-full relative rounded-2xl border border-black/20 dark:border-border bg-black/5 dark:bg-black/30 p-2.5 backdrop-blur-md shadow-2xl overflow-hidden group/dashboard">
					{/* Inner Glow Border */}
					...
					<div className="rounded-xl border border-border/40 bg-background/80 dark:bg-neutrals-12/90 overflow-hidden shadow-inner flex flex-col md:flex-row text-left h-[420px] md:h-[480px]">

						{/* Sidebar Mock */}
						<div className="w-full md:w-56 border-r border-border/40 bg-black/5 dark:bg-black/40 p-4 flex flex-col gap-5 shrink-0 hidden md:flex">
						...
						<div className="flex-1 p-6 flex flex-col relative overflow-hidden">
							...
							<div className="flex items-center gap-1.5 absolute top-4 right-4 bg-background/90 dark:bg-neutrals-13 border border-border/40 px-2.5 py-1 rounded-full text-[11px] font-medium shadow-sm z-20">
							...
							{/* Editor Content Area */}
							<div className="flex-1 flex flex-col gap-4 text-sm text-muted-foreground/90 leading-relaxed max-w-xl">
								<p>
								...
								<div className="flex flex-col gap-2 bg-black/5 dark:bg-white/5 border border-border/30 rounded-xl p-4 mt-2">
			...
			<section id="features" className="px-6 py-24 max-w-6xl mx-auto relative">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
					...
					<div className="md:col-span-2 rounded-2xl border border-black/20 dark:border-border bg-black/5 dark:bg-white/5 backdrop-blur-md p-8 flex flex-col justify-between overflow-hidden relative group/bento">
						...
						<div className="mt-8 flex gap-3 overflow-hidden border border-border/30 bg-background/50 dark:bg-neutrals-12/40 p-4 rounded-xl items-center relative shadow-sm">
					...
					<div className="rounded-2xl border border-black/20 dark:border-border bg-black/5 dark:bg-white/5 backdrop-blur-md p-8 flex flex-col justify-between overflow-hidden relative group/bento">
						...
						<div className="mt-8 bg-background/50 dark:bg-neutrals-12/40 border border-border/30 rounded-xl p-3.5 flex flex-col gap-2 text-xs">
					...
					<div className="rounded-2xl border border-black/20 dark:border-border bg-black/5 dark:bg-white/5 backdrop-blur-md p-8 flex flex-col justify-between overflow-hidden relative group/bento md:col-span-1">
			...
			<section id="testimonials" className="relative py-24 border-t border-border/10 bg-black/5 dark:bg-black/5">
				{/* Ambient Glows */}
				...
				<div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
					{USERS.map((item, idx) => (
						<CustomCard
							key={item.name}
							className="w-full border border-black/20 dark:border-border bg-background/60 dark:bg-neutrals-12/70 backdrop-blur-md rounded-xl p-5 shadow-sm hover:border-brand-primary-blue hover:shadow-[0_0_20px_rgba(86,143,248,0.05)] hover:scale-[1.01] transition-all duration-300 flex flex-col justify-between"
							cardHeader={
					...
					{PRICING_CARDS.map((card) => {
						...
						return (
							<CustomCard
								key={card.planType}
								className={cn(
									"w-full md:w-[360px] rounded-2xl border bg-background/40 dark:bg-black/30 backdrop-blur-xl relative p-6 flex flex-col justify-between overflow-hidden group/pricing transition-all duration-300",
									isPro
										? "border-brand-primary-purple/60 shadow-xl hover:border-brand-primary-purple/90"
										: "border-black/20 dark:border-border shadow-sm"
								)}
								cardHeader={
											...
											<Button
												...
												className={cn(
													...
													isPro
														...
														: "border-border/60 hover:bg-neutrals-12/10 dark:hover:bg-white/10"
												)}
											>
